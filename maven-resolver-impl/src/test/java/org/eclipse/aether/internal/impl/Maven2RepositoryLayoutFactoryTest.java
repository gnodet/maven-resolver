...
public class Maven2RepositoryLayoutFactoryTest {
    ...
    private void assertChecksum( ChecksumLocation actual, String expectedUri,
                                 ChecksumAlgorithmFactory expectedAlgorithmFactory )
    {
    ...
    public void testChecksumAlgorithmNames() {
        assertEquals( Arrays.asList( "SHA-1", "MD5" ), layout.getChecksumAlgorithmFactories().stream()
                .map( ChecksumAlgorithmFactory::getName ).collect( Collectors.toList() ) );
    }
    ...
    public void testMetadataLocation_GroupLevel() {
        DefaultMetadata metadata = new DefaultMetadata( "org.apache.maven.plugins", "maven-metadata.xml",
    ...
    public void testMetadataLocation_ArtifactLevel() {
        DefaultMetadata metadata = new DefaultMetadata( "org.apache.maven.plugins", "maven-jar-plugin",
    ...
    public void testMetadataLocation_VersionLevel() {
        DefaultMetadata metadata = new DefaultMetadata( "org.apache.maven.plugins", "maven-jar-plugin", "1.0-SNAPSHOT",
                                                        "maven-metadata.xml", Metadata.Nature.RELEASE_OR_SNAPSHOT );
        URI uri = layout.getLocation( metadata, false );
    ...
    @Test
    public void testArtifactChecksums_DownloadWithCustomAlgorithms()
    ...
    public void testArtifactChecksums_DownloadWithUnsupportedAlgorithms()
            throws NoRepositoryLayoutException
    {
    ...
    @Test
    public void testArtifactChecksums_UploadWithCustomAlgorithms()
            throws NoRepositoryLayoutException
    {
            ...
            throws Exception
    {
        ...
        try {
            ...
            assertTrue( message,
                    message.contains( Maven2RepositoryLayoutFactory.CONFIG_PROP_OMIT_CHECKSUMS_FOR_EXTENSIONS ) );
        }
    }
