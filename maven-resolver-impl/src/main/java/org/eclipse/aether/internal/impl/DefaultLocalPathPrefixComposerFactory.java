        ...
        extends LocalPathPrefixComposerFactorySupport
{
    ...
    public LocalPathPrefixComposer createComposer( RepositorySystemSession session ) {
        return new DefaultLocalPathPrefixComposer( isSplit( session ), getLocalPrefix( session ),
                                                   ...
                                                   isSplitRemote( session ), isSplitRemoteRepository( session ),
                                                   isSplitRemoteRepositoryLast( session ), getReleasesPrefix( session ),
            ...
            extends LocalPathPrefixComposerSupport
    {
        ...
        private DefaultLocalPathPrefixComposer( boolean split, String localPrefix, boolean splitLocal,
                                                ...
                                                boolean splitRemoteRepositoryLast, String releasesPrefix,
