...
public class PremanagedDependency {
                          ...
                          int managedBits, Dependency managedDependency, boolean premanagedState )
    {
        ...
        this.premanagedProperties = premanagedProperties != null
                                               ...
                                               boolean disableVersionManagement, boolean premanagedState )
    {
        ...
        return new PremanagedDependency( premanagedVersion, premanagedScope, premanagedOptional, premanagedExclusions,
                                         premanagedProperties, managedBits, dependency, premanagedState );
