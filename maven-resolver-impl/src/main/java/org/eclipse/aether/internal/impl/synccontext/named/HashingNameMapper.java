        ...
        implements NameMapper
{
    ...
    @Override
    public Collection<String> nameLocks( RepositorySystemSession session, Collection<? extends Artifact> artifacts,
                                         Collection<? extends Metadata> metadatas )
    {
        ...
        return delegate.nameLocks( session, artifacts, metadatas ).stream().map( n -> hashName( n, depth ) )
