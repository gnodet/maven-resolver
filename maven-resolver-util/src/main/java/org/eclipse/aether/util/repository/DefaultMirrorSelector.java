        ...
        implements MirrorSelector
{
    ...
    public RemoteRepository getMirror( RemoteRepository repository ) {
        ...
        RemoteRepository.Builder builder = new RemoteRepository.Builder( mirror.id, repository.getContentType(),
                                                                         mirror.url );
    ...
    static boolean isExternalHttpRepo( RemoteRepository repository ) {
        return ( "http".equalsIgnoreCase( repository.getProtocol() )
                ...
                || "dav+http".equalsIgnoreCase( repository.getProtocol() ) ) && !isLocal( repository.getHost() );
    }
