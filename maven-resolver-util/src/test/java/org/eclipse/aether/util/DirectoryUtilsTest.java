...
public class DirectoryUtilsTest {
    ...
    @Test
    public void expectedCasesRelative()
            throws IOException
    {
    ...
    @Test
    public void expectedCasesAbsolute()
            throws IOException
    {
    ...
    @Test
    public void existsButIsADirectory()
            throws IOException
    {
        // hack for surefire: sets the property but directory may not exist
        Files.createDirectories( Paths.get( System.getProperty( "java.io.tmpdir" ) ) );
    ...
    @Test
    public void existsButNotADirectory()
            throws IOException
    {
        // hack for surefire: sets the property but directory may not exist
        Files.createDirectories( Paths.get( System.getProperty( "java.io.tmpdir" ) ) );
    ...
    @Test
    public void notExistsAndIsCreated()
            throws IOException
    {
        // hack for surefire: sets the property but directory may not exist
        Files.createDirectories( Paths.get( System.getProperty( "java.io.tmpdir" ) ) );
