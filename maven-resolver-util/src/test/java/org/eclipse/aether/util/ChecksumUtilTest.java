...
public class ChecksumUtilTest {
            ...
            throws Throwable
    {
        ...
        for( Map.Entry<String, File> fileEntry : files.entrySet() ) {
            ...
            checksums = ChecksumUtils.calc( fileEntry.getValue(),
            ...
            for( Entry<String, Object> entry : checksums.entrySet() ) {
                ...
                assertEquals( String.format( "checksums do not match for '%s', algorithm '%s'",
                        fileEntry.getValue().getName(), entry.getKey() ), expected, actual );
            }
    ...
    @Test
    public void testCalcWithByteArray()
            throws Throwable
    {
        Map<String, Object> checksums = null;

        for( Map.Entry<String, byte[]> bytesEntry : bytes.entrySet() ) {
            checksums = ChecksumUtils.calc( bytesEntry.getValue(),
                    Arrays.asList( "SHA-512", "SHA-256", "SHA-1", "MD5" ) );
