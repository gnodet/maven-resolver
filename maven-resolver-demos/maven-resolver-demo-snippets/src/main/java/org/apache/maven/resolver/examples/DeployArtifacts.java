...
public class DeployArtifacts {
            ...
            throws Exception
    {
        ...
        Artifact jarArtifact = new DefaultArtifact( "test", "org.apache.maven.aether.examples", "", "jar",
                                                    "0.1-SNAPSHOT" );
        ...
        RemoteRepository distRepo = new RemoteRepository.Builder( "org.apache.maven.aether.examples", "default",
