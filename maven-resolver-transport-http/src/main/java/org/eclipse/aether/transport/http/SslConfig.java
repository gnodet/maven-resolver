...
final class SslConfig {
    ...
    SslConfig( RepositorySystemSession session, AuthenticationContext authContext ) {
        context = ( authContext != null ) ? authContext.get( AuthenticationContext.SSL_CONTEXT, SSLContext.class )
                : null;
    ...
    public boolean equals( Object obj ) {
        ...
        return Objects.equals( context, that.context ) && Objects.equals( verifier, that.verifier )
